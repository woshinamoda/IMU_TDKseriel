...
void process_sensor_output()
{
    ...
    if (quat6_data_was_set == 1)
    {
        if (hal.report & PRINT_GRV)
        {
            ...
            values[0] = atan2(2 * (q01 + q23), (1 - 2 * (q11 + q22))) * 180.f / (float) M_PI;
            values[1] = asin(2 * (q02 - q13)) * 180.f / (float) M_PI;
            values[2] = atan2(2 * (q03 + q12), (1 - 2 * (q22 + q33))) * 180.f / (float) M_PI;
            #else
            ...
            values[0] = asin(-2 * q1 * q3 + 2 * q0 * q2) * 57.3;   //yaw
            values[1] = atan2(2 * q2 * q3 + 2 * q0 * q1, -2 * q1 * q1 - 2 * q2 * q2 + 1) * 57.3; // roll
            values[2] = atan2(2 * (q1 * q2 + q0 * q3), q0 * q0 + q1 * q1 - q2 * q2 - q3 * q3) * 57.3; //pitch
            #endif
